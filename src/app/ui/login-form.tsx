  ...
  return (
    <form onSubmit={handleLogin} className="mx-auto mt-8 max-w-sm space-y-4">
      ...
      <label className="block">
        ...
        <input
          type="email"
          className="focus:ring-primary-500 dark:focus:ring-primary-300 mt-1 block w-full rounded border border-gray-300 bg-white px-3 py-2 text-gray-900 transition-colors focus:ring-2 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100"
          value={email}
